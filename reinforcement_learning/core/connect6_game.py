...
class Connect6Game:
    def __init__(self):
        ...
        self.winner = 0
        self.move_count = 0
        self.stones_placed = 0 # Stones placed in current turn
    ...
    def play(self, move_idx):
        ...
        self.moves.append(self._to_coord(r, c))
        ...
        # Check Turn End
        stones_needed = 1 if self.move_count == 0 else 2
        if self.stones_placed >= stones_needed:
